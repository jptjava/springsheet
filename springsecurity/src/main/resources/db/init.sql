...
*/
insert into USER (EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values ('kevin.m.bowersox@gmail.com', 'Kevin', 'Bowersox', 'password', 'admin', 'ROLE_ADMIN');
insert into USER (EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values ('johndoe@gmail.com', 'John', 'Doe', 'password', 'jodoe', 'ROLE_USER');
insert into USER (EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values ('janedoe@gmail.com', 'Jane', 'Doe', 'password', 'jadoe', 'ROLE_USER');
insert into USER (EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values ('juniordoe@gmail.com', 'Junior', 'Doe', 'password', 'jrdoe', 'ROLE_USER');
